<?php include 'includes/header.php'; ?>
			...
			<div class="view-header d-flex justify-content-between pl-3 pt-0 pb-0 pr-2">
				<nav class="nav">
					...
					<a class="nav-link  ck-active" href="">Add Member</a>
				</nav>
			  ...
			  <div class="ck-panel mt-2 pl-4 pt-2 pb-2 pr-3">
				<form class="ml-5" id="contact" autocomplete="off">
					<div class="form-group">
						<label for="email"><strong>Email:</strong></label>
						<input type="email" class="form-control" id="email" name="email" required>
					</div>
					<input type="submit" value="Send Invitation Link" class="btn btn-outline-success ck-btn">
				</form>	
				<div class ="appear-box animated" id="appear-box">
