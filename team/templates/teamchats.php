 <?php include 'includes/header.php'; ?>
			...
			<div class="view-header d-flex justify-content-between pl-3 pt-0 pb-0 pr-2">
				<nav class="nav">
					<a class="nav-link" href="index.php">Team Members</a>
					<a class="nav-link   ck-active" href="teamchats.php">Team Chats</a>
				</nav>
			  ...
			  <div class="row ck-panel  pl-3 pr-3">
			  	<div class="chatbox-ck">
			  		<div class="chatlogs-ck" id="chatlog">
						<?php foreach($chats as $chat): ?>
							<?php if($chat['member_id'] != $_SESSION['member_id']):?>
					  			<div class="chat-ck friend">
					  				<div class="photo-ck"><img src="templates/pics/<?php echo $chat['sender']; ?>" alt=""></div>
					  				<div class="message-ck"><p><?php echo $chat['chat']; ?></p></div>
					  			</div>
					  		<?php else: ?>
