			  ...
			  <div class="ck-panel mt-2 pl-4 pt-2 pb-2 pr-3">
			  		<div class="message-list">
			  			<ul>
			  				...
			  				<li id="sender-<?php echo $message['sender_id']; ?>" onclick="startChat(<?php echo $message['sender_id'] ;?>)">
			  					<div class="member-photo"><img src="templates/pics/<?php echo $message['sender_pic'];?>" alt=""></div>
			  					<div class="textchat-info">
			  						<span class="infor-ck"><?php echo $message['fname'].' '. $message['lname'];?></span><span class="badge badge-danger ml-2"></span>
									<div class="text-ck">
										<?php if(isset($message['reply'])) {echo '<span style="color:black;font-style:italics;">Me: </span>';} ?><?php echo $message['message']; ?>
									</div>
			  					</div>
