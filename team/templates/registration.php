...
<head>
	...
	<title>Create membership Account</title>
...
<body>
 <div class="ck-bgshade">
	...
	<div class="ck-caption pb-1"><h5>Register to Join your Team</h5></div>
	...
	<div class="ck-section">
		...
		<form action="registration.php" method="post" class="ck-form" enctype="multipart/form-data" autocomplete="off">
			...
			<div class="form-group mt-1">
				...
				<input type="text" class="form-control" id="job" placeholder="Job Title e.g Managing Director, Programmer, Financial Accountant etc" name="job" required>
			</div>
			<div class="row">
				<div class="col">
